        ...
        <table class="datosUsuario carrito">
          ...
          if(mysqli_num_rows($reMostrarCompras)==0){
            echo "<table>
              ...
              <tr><td align='justify'>
                <p>Usted no ha realizado pedido nada con nosotros hasta el momento. Para hacerlo debe hacer click la opci&oacute;n del menu \"Productos\" y a&ntilde;adir productos al carrito.</p>
              </td></tr>
            </table>";
          }else{
